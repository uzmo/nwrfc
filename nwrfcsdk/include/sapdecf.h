/* @(#) $Id: //bas/753_REL/src/base/api/sapdecf.h#1 $ SAP*/
/*-----------------------------------------------------------------------------
 *
 ...
 */
void DecFloat_InitializeDBmode(DecFloatDBmode decfDBmode);
...
DECF_RETURN DecFloat16ToSAP_LLONG(SAP_LLONG* l, DecFloat16  dfp16);  
 ...
 *           DECF_NO_MEMORY 
 */
DECF_RETURN SAP_LLONGToDecFloat16(DecFloat16*  dfp16_res, SAP_LLONG l); 
...
DECF_RETURN DecFloat34ToSAP_LLONG(SAP_LLONG* l, DecFloat34  dfp34);  
...
DECF_RETURN SAP_LLONGToDecFloat34(DecFloat34*  dfp34_res, SAP_LLONG l);  
